                ...
                <?php
                    if($status == 'checkout' || $status == 'order')
                    {
                        echo "<div class='row mb-2'>
                            <div class='col-md-8'>
                                <a href='order.php' class='btn btn-lg btn-block btn-warning font-weight-bold my-3 py-3'>Place Order</a>
                            </div>
                            <div class='col-md-4'>
                                <a href='cancel.php' class='btn btn-lg btn-block btn-danger font-weight-bold my-3 py-3'>Cancel</a>
                            </div>
                        </div>";
                    }
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="bayar.php" class="btn text-white" style="background-color: #fe0018;">Bayar</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="bni" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <a href="bayar.php" class="btn text-white" style="background-color: #e85d26;">Bayar</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="bsi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <a href="bayar.php" class="btn text-white" style="background-color: #1da29d;">Bayar</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="gopay" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <a href="bayar.php" class="btn text-white" style="background-color: #00aa13;">Bayar</a>
          </div>
        </div>
      </div>
    </div>
