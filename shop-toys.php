                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                ...
                                <a href="addToCart.php?id_produk=<?= $datas['id'] ?>&url=shop-toys&harga_produk=<?= $datas['harga'] ?>" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-warning mr-1"></i>Add To Cart</a>
                            </div>
                        </div>
                    </div>  
                    <?php } endforeach; ?>
