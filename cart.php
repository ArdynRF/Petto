                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                                        <a href="reduce.php?id_produk=<?= $r['id_produk']?>&url=cart&harga_produk=<?= $r['harga_produk'] ?>" class="btn btn-sm btn-warning btn-minus" >
                                            <i class="fa fa-minus"></i>
                                        </a>
                                    </div>
                                    <input type="text" class="form-control form-control-sm bg-secondary text-center" value="<?= $r['banyak_produk']; ?>">
                                    <div class="input-group-btn">
                                        <a href="addToCart.php?id_produk=<?= $r['id_produk']?>&url=cart&harga_produk=<?= $r['harga_produk'] ?>" class="btn btn-sm btn-warning btn-plus">
                            ...
                            <td class="align-middle"><a href="delete.php?id_produk=<?= $r['id_produk'] ?>&banyak=<?= $r['banyak_produk'] ?>&total=<?= $r['total'] ?>" class="btn btn-sm btn-warning"><i class="fa fa-times"></i></a></td>
                        </tr>
                        <?php endforeach; ?>
            ...
            <div class="col-lg-4">
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        ...
                        {
                            echo "<a href='toCheckout.php' class='btn btn-block btn-warning my-3 py-3'>Proceed To Checkout</a>";
                        }
                        ?>
                    </div>
                </div>
